...
namespace WindowsFormsApplication1
{
    public class WorkOrderCollection
    {
        ...
        {
            orders.Add(new WorkOrder("100", "ProductA", "Joe", new DateTime(2016, 3, 13), 2000));
            orders.Add(new WorkOrder("101", "ProductC", "John", new DateTime(2016, 3, 14), 5000));
            ...
            orders.Add(new WorkOrder("104", "ProductB", "Gareth", new DateTime(2016, 3, 13), 5000));
            orders.Add(new WorkOrder("105", "ProductA", "David", new DateTime(2016, 3, 14), 3000));
